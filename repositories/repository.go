...
type Repository interface {
	...
	GetDcddUserTotals(fromDate, toDate *time.Time, school_or_eccd_id, dzongkhag_id *uuid.UUID, category *string) (totalAll int, totalActive int, totalInActive, totalNew int, err error)
